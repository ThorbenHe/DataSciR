...
```{r ui, echo=FALSE,warning=FALSE}
 ...
 ui <- fluidPage(theme = shinytheme("lumen"),titlePanel("Multi-Perspective and Predictive Analysis of Forests; the Issues, Challenges and Global Trends"),actionButton("test","Full Screen"),fullscreen_all(click_id = "test"),
    tabsetPanel(
