...
Relation of reforestation increase between 1990-2020 to forest area in 1990 (join with fra dataset)
...
increase %>%
  ...
  labs(
    y = "Increase in %",
    x = NULL,
    title = "Countries and their increase in reforestation \nfrom 1990-2020 in relation to their total forest \narea in 1990"
  ) +
  coord_flip()
```
...
labs(x = NULL, y = NULL, title = "Increase in reforestation between 1990 and 2020 in Percent", fill = "")
```
...
pear
```
Almost no significant correlation -> At least in the last 30 years, countries did not try to make up for a human driven deforestation 
