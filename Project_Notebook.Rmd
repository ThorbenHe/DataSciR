...
"Wildfire" is the target we want to predict and has either the value "No", if we have a missing value or the value of wildfires is 0, and "Yes" otherwise. So we have a binary classification task.
...
Note: we have to many countries to be properly visualized in the decision tree above. Below the tree you can find the textual representation of it where you can look at all the countries and the decision they belong to.
